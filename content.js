 ...
 * 
 * With added Subscription, Library, and History buttons for the home page by Hunter Ball
 *
  ...
  if (window.location.pathname === "/") {
    ...
    <div class="home-container">
      ...
      <div class="myYtButtonsContainer">
        <a class="myYtButton" href="https://www.youtube.com/feed/subscriptions"><span><svg viewBox="0 0 24 24" preserveAspectRatio="xMidYMid meet" focusable="false" style="pointer-events: none;"><path d="M10,18v-6l5,3L10,18z M17,3H7v1h10V3z M20,6H4v1h16V6z M22,9H2v12h20V9z M3,10h18v10H3V10z"></path></svg> My Subscriptions</span></a>
        <a class="myYtButton" href="https://www.youtube.com/feed/library"><span><svg viewBox="0 0 24 24" preserveAspectRatio="xMidYMid meet" focusable="false"" style="pointer-events: none;"><path d="M11,7l6,3.5L11,14V7L11,7z M18,20H4V6H3v15h15V20z M21,18H6V3h15V18z M7,17h13V4H7V17z"></path></svg> Library</span></a>
        <a class="myYtButton" href="https://www.youtube.com/feed/history"><span><svg viewBox="0 0 24 24" preserveAspectRatio="xMidYMid meet" focusable="false" style="pointer-events: none;"><path d="M14.97,16.95L10,13.87V7h2v5.76l4.03,2.49L14.97,16.95z M22,12c0,5.51-4.49,10-10,10S2,17.51,2,12h1c0,4.96,4.04,9,9,9 s9-4.04,9-9s-4.04-9-9-9C8.81,3,5.92,4.64,4.28,7.38C4.17,7.56,4.06,7.75,3.97,7.94C3.96,7.96,3.95,7.98,3.94,8H8v1H1.96V3h1v4.74 C3,7.65,3.03,7.57,3.07,7.49C3.18,7.27,3.3,7.07,3.42,6.86C5.22,3.86,8.51,2,12,2C17.51,2,22,6.49,22,12z"></path></svg> History</span></a>
      </div>   
    </div>
    `;
